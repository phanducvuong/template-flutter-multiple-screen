...
import 'package:flutter_responsive/src/config/image_config.dart';
import 'package:flutter_responsive/src/config/size_config.dart';
import 'package:flutter_responsive/src/res/string.dart';
      ...
      child: Align(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: Styles.topBarBackgroundColor,
          ),
          child: Row(
            children: <Widget>[
              Expanded(
